FROM python:3
WORKDIR /usr/src/app
MAINTAINER Juan Manuel Duran Piñero "juanmadupi@gmail.com"
...
RUN git clone https://github.com/Juanmanueldupi/practicapythondjangotutorial.git /usr/src/app && mkdir static
